...
\newcommand{\snapshot}[2]{%
  \begin{minipage}[t]{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth,height=43mm,keepaspectratio]{#1}
    \captionof{figure}{#2}
  \end{minipage}
}
...
\begin{center}
\snapshot{01-home.png}{Home screen with the 3D menu preview.}
\hfill
\snapshot{02-level-select.png}{Level selection screen with progress-aware level buttons.}

\vspace{4mm}

\snapshot{03-gameplay.png}{Gameplay view with the block, board, HUD, and goal tile.}
\hfill
\snapshot{04-hint.png}{Hint view after pressing H. The solver highlights the next occupied cells.}

\vspace{4mm}

\snapshot{05-editor.png}{Editor view with the tool strip and raycast placement grid.}
\hfill
\snapshot{06-mobile.png}{Mobile viewport test with the same gameplay scene and responsive HUD.}
\end{center}
\clearpage

...
const MeshPortalMaterial = shaderMaterial({
  blur: 0,
  map: null,
  sdf: null,
  size: 0,
 ...
 */
const meshPortalMaterialApplySDF = (portalMesh, resolution, gl) => {
  const maskRenderTarget = new THREE.WebGLRenderTarget(resolution, resolution);
  const portalMat = portalMesh.material;
...
export { MeshPortalMaterial, meshPortalMaterialApplySDF };
